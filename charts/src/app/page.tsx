  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
     ...
     <Link className="inline-block px-6 py-3 rounded-2xl bg-red-600 text-white font-semibold shadow-md hover:bg-green-700 hover:shadow-lg transition-all duration-300" href='/graficoPolar'>Ir al grafico Polar/ Valor Max Planificador</Link> 
      ...
      <Link className="inline-block px-6 py-3 rounded-2xl bg-blue-600 text-white font-semibold shadow-md hover:bg-green-700 hover:shadow-lg transition-all duration-300" href='/graficoDona2'>Ir al grafico de Dona/ Suma por total de marca</Link> 
