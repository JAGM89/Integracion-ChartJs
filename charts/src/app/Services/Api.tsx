...
export async function fetchValorMaximoPlanificador(){

    const response=await axios.get(`${API_URL}/valor-maximo-planificador`);
    return response.data;
}

export async function fetchPorMarca(){

    const response=await axios.get(`${API_URL}/total-marca`);
    return response.data;
}

export async function fetchMarcaPorZona(){

    const response=await axios.get(`${API_URL}/marca-zona`);
    return response.data;
}
